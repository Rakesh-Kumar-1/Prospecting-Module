...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'b81d17d3-e73c-11f0-bf6b-04d4c47a061e:1-49';
...
INSERT INTO `md_languages` VALUES ('AR','Arabic','العربية','RTL',1,6),('BN','Bengali','বাংলা','LTR',1,23),('DA','Danish','Dansk','LTR',1,20),('DE','German','Deutsch','LTR',1,11),('EN','English','English','LTR',1,1),('ES','Spanish','Español','LTR',1,9),('FA','Farsi/Persian','فارسی','RTL',1,32),('FI','Finnish','Suomi','LTR',1,22),('FR','French','Français','LTR',1,10),('GU','Gujarati','ગુજરાતી','LTR',1,25),('HE','Hebrew','עברית','RTL',1,33),('HI','Hindi','हिन्दी','LTR',1,2),('ID','Indonesian','Bahasa Indonesia','LTR',1,35),('IT','Italian','Italiano','LTR',1,15),('JA','Japanese','日本語','LTR',1,5),('KN','Kannada','ಕನ್ನಡ','LTR',1,28),('KO','Korean','한국어','LTR',1,14),('ML','Malayalam','മലയാളം','LTR',1,29),('MR','Marathi','मराठी','LTR',1,24),('MS','Malay','Bahasa Melayu','LTR',1,3),('NL','Dutch','Nederlands','LTR',1,17),('NO','Norwegian','Norsk','LTR',1,21),('PA','Punjabi','ਪੰਜਾਬੀ','LTR',1,30),('PL','Polish','Polski','LTR',1,18),('PT','Portuguese','Português','LTR',1,12),('RU','Russian','Русский','LTR',1,13),('SV','Swedish','Svenska','LTR',1,19),('TA','Tamil','தமிழ்','LTR',1,26),('TE','Telugu','తెలుగు','LTR',1,27),('TH','Thai','ภาษาไทย','LTR',1,4),('TR','Turkish','Türkçe','LTR',1,16),('UR','Urdu','اردو','RTL',1,31),('VI','Vietnamese','Tiếng Việt','LTR',1,34),('ZH_CN','Chinese (Simplified)','中文(简体)','LTR',1,7),('ZH_TW','Chinese (Traditional)','中文(繁體)','LTR',1,8);
...
INSERT INTO `md_stages` VALUES (1,'PENDING',1,1),(2,'CONTACTED',2,1),(3,'INTERESTED',3,1),(4,'QUALIFIED',4,1),(5,'CONVERTED',5,1),(6,'DROPPED',6,1),(7,'HOLD',7,1),(8,'DEFERRED',8,1);
...
-- Dump completed on 2026-04-28 22:04:27
